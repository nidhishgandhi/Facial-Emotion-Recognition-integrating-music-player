        ...
        try:
           ...
           # mp = 'C:/Program Files (x86)/Windows Media Player/wmplayer.exe'
            ...
            # subprocess.call([mp, file])
                ...
                cv2.waitKey(1000)
                url = 'C://djmusic//music//templates//Angry//store.html'
            ...
            # subprocess.call([mp, file])
                ...
                cv2.imshow("Detect your emotions here", im)
                cv2.waitKey(1000)
                url = 'C://djmusic//music//templates//Happy//store.html'
                webbrowser.open(url, new=1)
                break
            ...
            # subprocess.call([mp, file])
                ...
                cv2.imshow("Detect your emotions here", im)
                cv2.waitKey(1000)
                url = 'C://djmusic//music//templates//Sad//store.html'
                webbrowser.open(url, new=1)
                break
            ...
            # subprocess.call([mp, file])
                ...
                cv2.imshow("Detect your emotions here", im)
                cv2.waitKey(1000)
                url = 'C://djmusic//music//templates//Surprise//store.html'
                webbrowser.open(url, new=1)
                break    
        except:
